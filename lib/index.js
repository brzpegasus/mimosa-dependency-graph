'use strict';
var assets, basePath, config, dataFile, fs, logger, mimosaRequire, path, registration, utils, _, _generateGraphData, _writeStaticAssets,
  __slice = [].slice;
...
_generateGraphData = function(mimosaConfig, options, next) {
  var data, dep, dependencies, dependencyInfo, filename, link, links, module, node, nodes, _i, _len;
